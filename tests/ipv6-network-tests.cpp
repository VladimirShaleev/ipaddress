...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        std::make_tuple("2001:db8::/", error_code::EmptyNetmask, "empty mask in address 2001:db8::/"),
        std::make_tuple("2001:db8::/129", error_code::InvalidNetmask, "is not a valid netmask in address 2001:db8::/129"),
        std::make_tuple("2001:db8::/255.255.255.255", error_code::InvalidNetmask, "is not a valid netmask in address 2001:db8::/255.255.255.255"),
        std::make_tuple("/%scope", error_code::InvalidNetmask, "is not a valid netmask in address /%scope"),
        std::make_tuple("/%scope8", error_code::InvalidNetmask, "is not a valid netmask in address /%scope8"),
        std::make_tuple("::1/::1", error_code::InvalidNetmask, "is not a valid netmask in address ::1/::1"),
        std::make_tuple("::1/1::", error_code::InvalidNetmask, "is not a valid netmask in address ::1/1::"),
        std::make_tuple("::1/-1", error_code::InvalidNetmask, "is not a valid netmask in address ::1/-1"),
        std::make_tuple("::1/+1", error_code::InvalidNetmask, "is not a valid netmask in address ::1/+1"),
        std::make_tuple("::1/ 1 ", error_code::InvalidNetmask, "is not a valid netmask in address ::1/ 1 "),
        std::make_tuple("::1/word", error_code::InvalidNetmask, "is not a valid netmask in address ::1/word"),
        std::make_tuple("::1/::", error_code::InvalidNetmask, "is not a valid netmask in address ::1/::"),
        std::make_tuple("::1%scope/word", error_code::InvalidNetmask, "is not a valid netmask in address ::1%scope/word"),
        
        std::make_tuple("2001:db8::/24", error_code::HasHostBitsSet, "has host bits set in address 2001:db8::/24"),
        std::make_tuple("2001:db8:://", error_code::OnlyOneSlashPermitted, "only one '/' permitted in address 2001:db8:://"),
        std::make_tuple("2001:db8:://128", error_code::OnlyOneSlashPermitted, "only one '/' permitted in address 2001:db8:://128"),
        std::make_tuple("2001:db8::/128/128", error_code::OnlyOneSlashPermitted, "only one '/' permitted in address 2001:db8::/128/128"),

        std::make_tuple("/8", error_code::EmptyAddress, "address cannot be empty"),
        std::make_tuple("google.com", error_code::OctetHasInvalidSymbol, "in octet 0 of address google.com has invalid symbol"),
        std::make_tuple("1.2.3.4", error_code::Least3Parts, "least 3 parts in address 1.2.3.4"),
        std::make_tuple("10/8", error_code::Least3Parts, "least 3 parts in address 10/8"),
        std::make_tuple("1234:axy::b", error_code::PartHasInvalidSymbol, "in part 0 of address 1234:axy::b has invalid symbols"),
        std::make_tuple("google.com%scope", error_code::OctetHasInvalidSymbol, "in octet 0 of address google.com%scope has invalid symbol"),
        std::make_tuple("1.2.3.4%scope", error_code::Least3Parts, "least 3 parts in address 1.2.3.4%scope"),
        std::make_tuple("10%scope/8", error_code::Least3Parts, "least 3 parts in address 10%scope/8"),
        std::make_tuple("1234:axy::b%scope", error_code::PartHasInvalidSymbol, "in part 0 of address 1234:axy::b%scope has invalid symbols")
    ));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        std::make_tuple("2001:658:22a:cafe::/64", 1, 65, error_code::NewPrefixMustBeShorter, "new prefix must be shorter"),
        std::make_tuple("2001:658:22a:cafe::/64", 2, 63, error_code::CannotSetPrefixlenDiffAndNewPrefix, "cannot set prefixlen_diff and new_prefix"),
        std::make_tuple("2001:658:22a:cafe::/64", 65, nullptr, error_code::InvalidPrefixlenDiff, "invalid prefixlen_diff")
    ));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        std::make_tuple("2001:658:22a:cafe::/120", 1, 119, error_code::NewPrefixMustBeLonger, "new prefix must be longer"),
        std::make_tuple("2001:658:22a:cafe::/120", 2, 121, error_code::CannotSetPrefixlenDiffAndNewPrefix, "cannot set prefixlen_diff and new_prefix"),
        std::make_tuple("2001:658:22a:cafe::/120", 1, 500, error_code::InvalidPrefixlenDiff, "invalid prefixlen_diff")
    ));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        std::make_tuple("2001:658:22a:caff::/120", "2001:658:22a:cafe::/122", error_code::NotContainedNetwork, "network is not a subnet of other")
    ));
