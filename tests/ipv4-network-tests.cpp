...
TEST(ipv4_network, CompileTime) {
    ...
    ASSERT_EQ(net5_error, error_code::HasHostBitsSet);
...
TEST(ipv4_network, from_address_error) {
    ...
    ASSERT_EQ(err, error_code::HasHostBitsSet);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        std::make_tuple("1.2.3.4/", error_code::EmptyNetmask, "empty mask in address 1.2.3.4/"),
        std::make_tuple("1.2.3.4/33", error_code::InvalidNetmask, "is not a valid netmask in address 1.2.3.4/33"),
        std::make_tuple("1.2.3.4/255.0.0.256", error_code::InvalidNetmask, "is not a valid netmask in address 1.2.3.4/255.0.0.256"),
        std::make_tuple("1.2.3.4/-1", error_code::InvalidNetmask, "is not a valid netmask in address 1.2.3.4/-1"),
        std::make_tuple("1.2.3.4/+1", error_code::InvalidNetmask, "is not a valid netmask in address 1.2.3.4/+1"),
        std::make_tuple("1.2.3.4/ 1 ", error_code::InvalidNetmask, "is not a valid netmask in address 1.2.3.4/ 1 "),
        std::make_tuple("1.2.3.4/0x1", error_code::InvalidNetmask, "is not a valid netmask in address 1.2.3.4/0x1"),
        std::make_tuple("1.2.3.4/254.254.255.256", error_code::InvalidNetmask, "is not a valid netmask in address 1.2.3.4/254.254.255.256"),
        std::make_tuple("1.2.3.4/1.a.2.3", error_code::InvalidNetmask, "is not a valid netmask in address 1.2.3.4/1.a.2.3"),
        std::make_tuple("1.1.1.1/254.xyz.2.3", error_code::InvalidNetmask, "is not a valid netmask in address 1.1.1.1/254.xyz.2.3"),
        std::make_tuple("1.1.1.1/pudding", error_code::InvalidNetmask, "is not a valid netmask in address 1.1.1.1/pudding"),
        std::make_tuple("1.1.1.1/::", error_code::InvalidNetmask, "is not a valid netmask in address 1.1.1.1/::"),

        std::make_tuple("1.2.3.4/255.255.255.127", error_code::NetmaskPatternMixesZeroesAndOnes, "netmask pattern mixes zeroes & ones in address 1.2.3.4/255.255.255.127"),
        std::make_tuple("1.2.3.4/255.255.255.251", error_code::NetmaskPatternMixesZeroesAndOnes, "netmask pattern mixes zeroes & ones in address 1.2.3.4/255.255.255.251"),
        std::make_tuple("1.1.1.1/240.255.0.0", error_code::NetmaskPatternMixesZeroesAndOnes, "netmask pattern mixes zeroes & ones in address 1.1.1.1/240.255.0.0"),
        std::make_tuple("1.1.1.1/255.254.128.0", error_code::NetmaskPatternMixesZeroesAndOnes, "netmask pattern mixes zeroes & ones in address 1.1.1.1/255.254.128.0"),
        std::make_tuple("1.1.1.1/0.1.127.255", error_code::NetmaskPatternMixesZeroesAndOnes, "netmask pattern mixes zeroes & ones in address 1.1.1.1/0.1.127.255"),

        std::make_tuple("1.2.3.4/24", error_code::HasHostBitsSet, "has host bits set in address 1.2.3.4/24"),
        std::make_tuple("1.2.3.4//", error_code::OnlyOneSlashPermitted, "only one '/' permitted in address 1.2.3.4//"),
        std::make_tuple("1.2.3.4//32", error_code::OnlyOneSlashPermitted, "only one '/' permitted in address 1.2.3.4//32"),
        std::make_tuple("1.2.3.4/32/24", error_code::OnlyOneSlashPermitted, "only one '/' permitted in address 1.2.3.4/32/24"),

        std::make_tuple("/", error_code::EmptyNetmask, "empty mask in address /"),
        std::make_tuple("/8", error_code::EmptyAddress, "address cannot be empty"),
        std::make_tuple("bogus", error_code::OctetHasInvalidSymbol, "in octet 0 of address bogus has invalid symbol"),
        std::make_tuple("example.com", error_code::OctetHasInvalidSymbol, "in octet 0 of address example.com has invalid symbol"),
        std::make_tuple("10/8", error_code::Expected4Octets, "expected 4 octets in 10/8"),
        std::make_tuple("::1.2.3.4", error_code::OctetHasInvalidSymbol, "in octet 0 of address ::1.2.3.4 has invalid symbol"),
        std::make_tuple("1.2.3.256", error_code::OctetExceeded255, "octet 0 of address 1.2.3.256 exceeded 255")
    ));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        std::make_tuple("192.0.2.0/24", 1, 25, error_code::NewPrefixMustBeShorter, "new prefix must be shorter"),
        std::make_tuple("192.0.2.0/24", 2, 23, error_code::CannotSetPrefixlenDiffAndNewPrefix, "cannot set prefixlen_diff and new_prefix"),
        std::make_tuple("192.0.2.0/24", 25, nullptr, error_code::InvalidPrefixlenDiff, "invalid prefixlen_diff")
    ));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        std::make_tuple("192.0.2.0/24", 1, 23, error_code::NewPrefixMustBeLonger, "new prefix must be longer"),
        std::make_tuple("192.0.2.0/24", 2, 25, error_code::CannotSetPrefixlenDiffAndNewPrefix, "cannot set prefixlen_diff and new_prefix"),
        std::make_tuple("192.0.2.0/24", 1, 33, error_code::InvalidPrefixlenDiff, "invalid prefixlen_diff")
    ));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        std::make_tuple("192.168.1.128/30", "192.168.1.0/24", error_code::NotContainedNetwork, "network is not a subnet of other")
    ));
