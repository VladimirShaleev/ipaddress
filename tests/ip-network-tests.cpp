...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        std::make_tuple("1.2.3.4/33", error_code::Least3Parts, "least 3 parts in address 1.2.3.4/33"),
        std::make_tuple("1.2.3.4/255.255.255.127", error_code::InvalidNetmask, "is not a valid netmask in address 1.2.3.4/255.255.255.127"),
        std::make_tuple("1.2.3.4/24", error_code::Least3Parts, "least 3 parts in address 1.2.3.4/24"),
        std::make_tuple("1.2.3.4//", error_code::OnlyOneSlashPermitted, "only one '/' permitted in address 1.2.3.4//"),
        std::make_tuple("bogus", error_code::PartIsMore4Chars, "in part 0 of address bogus more 4 characters"),
