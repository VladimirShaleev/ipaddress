...
class collapsed_addresses_vector {
public:
    using value_type             = T; /**< The network type. */
    using size_type              = size_t; /**< An unsigned integral type. */
    using difference_type        = ptrdiff_t; /**< Unsigned integer type for differences. */
    using pointer                = value_type*; /**< Pointer to the network type. */
    using const_pointer          = const value_type*; /**< Const pointer to the network type. */
    using reference              = value_type&; /**< Reference to the network type. */
    using const_reference        = const value_type&; /**< Const reference to the network type. */
    using iterator               = value_type*; /**< Iterator for summarize network range. */
    using const_iterator         = const value_type*; /**< Const iterator for summarize network range. */
    using reverse_iterator       = ip_reverse_iterator<iterator>; /**< Reverse iterator for subnet traversal. */
    using const_reverse_iterator = ip_reverse_iterator<const_iterator>; /**< Const reverse iterator for subnet */
     ...
     * Default constructor.
     */
    IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE collapsed_addresses_vector() IPADDRESS_NOEXCEPT = default;

    /**
     * Gets the beginning iterator of the sequence.
     * 
     * @return A iterator to the first element in the sequence.
     */
     ...
     * Gets the end iterator of the sequence.
     * 
     * @return A iterator to the element following the last element in the sequence.
     */
    ...
    IPADDRESS_NODISCARD IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE size_type capacity() const IPADDRESS_NOEXCEPT {
        return N;
    }
    ...
    IPADDRESS_NODISCARD IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE size_type max_size() const IPADDRESS_NOEXCEPT {
        return N;
    }
     ...
     * @return The element at the specified index.
     */
    IPADDRESS_NODISCARD IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE reference operator[](difference_type n) IPADDRESS_NOEXCEPT {
        return at(n);
    }
     ...
     * @return The element at the specified index.
     */
    IPADDRESS_NODISCARD IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE const_reference operator[](difference_type n) const IPADDRESS_NOEXCEPT {
        return at(n);
    }
     ...
     * @return The element at the specified index.
     */
    IPADDRESS_NODISCARD IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE reference at(difference_type n) IPADDRESS_NOEXCEPT {
        return _data[n];
    }
     ...
     * @return The element at the specified index.
     */
    IPADDRESS_NODISCARD IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE const_reference at(difference_type n) const IPADDRESS_NOEXCEPT {
        return _data[n];
    }
    ...
    template <typename V>
    IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE iterator insert(const_iterator pos, const V& value) IPADDRESS_NOEXCEPT {
        alloc_data(pos) = value;
        return const_cast<iterator>(pos);
    }

    template <typename K, typename V>
    IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE iterator insert(const_iterator pos, const std::pair<K, V>& value) IPADDRESS_NOEXCEPT {
        auto& data = alloc_data(pos);
    ...
    IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE void push_back(const_reference value) IPADDRESS_NOEXCEPT {
        _data[_size++] = value;
    }

    IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE void push_back(value_type&& value) IPADDRESS_NOEXCEPT {
    ...
    IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE iterator erase(iterator pos) IPADDRESS_NOEXCEPT {
        free_data(pos);
        return pos;
    }
...
private:
    IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE reference alloc_data(const_iterator pos) IPADDRESS_NOEXCEPT {
        auto index = difference_type(&(*pos) - _data);
        if (index < _size) {
            for (auto i = difference_type(_size) - index - 1; i >= index; --i) {
                _data[i + 1] = _data[i];
            }
        }
        ++_size;
    ...
    IPADDRESS_CONSTEXPR IPADDRESS_FORCE_INLINE void free_data(const_iterator pos) IPADDRESS_NOEXCEPT {
        auto i = difference_type(&(*pos) - _data);
        if (i != _size - 1) {
            for (; i < difference_type(_size); ++i) {
                _data[i] = _data[i + 1];
            }
        }
        --_size;
